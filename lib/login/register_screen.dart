...
class RegisterScreen extends StatelessWidget {
  ...
  final VoidCallback onRegisterSuccess; // THÊM DÒNG NÀY

  const RegisterScreen({
    super.key, 
    required this.onNavigateToLogin,
    required this.onRegisterSuccess, // THÊM DÒNG NÀY
  });
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _buildPrimaryButton("Đăng ký", Icons.person_add_alt_1_rounded, onRegisterSuccess),
            ],
          ),
        ),
      ),
  ...
  // Các hàm helper tương tự LoginScreen (sử dụng onPressed cho nút chính)
